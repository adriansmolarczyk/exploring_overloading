...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int anInt = 10;
        String aString = "I am a beautiful String";
    ...
    void printStuff(String myString){
        ...
        Log.i("info","My String: "+myString);
    }

    void printStuff(int myInt, String myString){
        Log.i("info","This is the combined int + String version");
        Log.i("info","My int + String: "+ myInt + " " + myString);
    }
